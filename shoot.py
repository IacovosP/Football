...
matchShots = map(float, (sys.argv[1].split(',')))
#print 'Improved List:', (matchShots)

f = pd.read_csv(open("D:/Users/Jackys/IdeaProjects/Football Saveability/angle_distance2.csv"),encoding='utf-8')
...
#print(a)
#print(matchShots)
test_data_matchShots = pd.DataFrame([matchShots],columns=f_names)

#print(test_data_a)
#print(clf.score(test_data,test_target))
print(clf.predict_proba(test_data_matchShots))
print
prob_loss = []
prob_win = []
wl = []
